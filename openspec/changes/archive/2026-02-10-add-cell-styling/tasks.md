...
- [x] **1.1** Add `parse_cell_address(addr)` function to texnative_core.lua
...
- [x] **1.2** Add `parse_tbl_cells(str)` function to texnative_core.lua
...
- [x] **2.1** Build 2D cell_styles array in `generate_tabularray()`
...
- [x] **2.2** Modify `get_rows_data()` signature and implementation
...
- [x] **2.3** Integration tests for cell styling
